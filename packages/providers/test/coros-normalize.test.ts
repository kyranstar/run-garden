...
// The old per-provider sport-name helper and its admit-list were retired in
// favor of the registry-based sportIdForCorosCode (@rg/domain,
// packages/domain/src/sport.ts — see packages/domain/test/sport.test.ts for
// its coverage).
